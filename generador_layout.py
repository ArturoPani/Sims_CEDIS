...
def main():
    ...
    # este código deberá eliminarse eventualmente, pero lo dejo por compatibilidad con las primeras versioens (seed12)
    # (Con default seed12, este if solo aplica si pasan --prefijo explícitamente)
    if args.prefijo is not None and args.escenario == "seed12":
